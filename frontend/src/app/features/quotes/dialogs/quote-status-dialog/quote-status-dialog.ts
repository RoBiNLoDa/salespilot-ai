...
import { QuoteStatusDialogData } from '@features/quotes/models/quote-status-dialog-data';
...
export class QuoteStatusDialog implements OnInit {
  ...
  readonly data = inject<QuoteStatusDialogData>(MAT_DIALOG_DATA);
  ...
  private readonly allowedTransitions: Record<QuoteStatus, QuoteStatus[]> = {
  ...
  readonly statuses = computed(() => {
    const currentStatus = this.data.quote.status;
